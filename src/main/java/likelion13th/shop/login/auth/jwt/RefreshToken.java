...
/*
* 1) 왜 필요한가?
* - JWT가 서버가 토큰을 기억하지 않기에, 재발급을 하기 위해 Refresh Token이 필요하다
* - 한 명의 사용자(User)당 Refresh Token 1개를 보관하는 테이블이다
*
* 2) 없으면 / 틀리면?
* - 클라이언트가 Access Token 만료 시 재발급 받을 수 없음
* - 없으면 매번 사용자는 다시 로그인해야 한다
*
* */